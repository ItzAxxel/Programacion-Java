...
public class AxelArroyoGimenezEjercicioNumeroHasta0 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Algorisme que demani números fins que s’introdueixi un 0. Aleshores s’ha de
		 * imprimir la suma i la mitja de tots els números introduïts.
		 * 
		 */
		...
		int cantidad = 0; // Variable para contar la de veces que el usuario introduce un número
		int media = 0; // Variable para poder hacer la media

		while (numero != 0) { // Mientras que el numero sea diferente a 0, el programa se repetirá
